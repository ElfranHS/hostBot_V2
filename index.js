...
function title() {
      console.clear()
	  console.log(chalk.bold.green(figlet.textSync('CRISTIAN', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n         ${chalk.yellow('[ Created By Cristain ]')}\n\n${chalk.red('CRSH Bot')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Instagram')} : ${chalk.white('@cristian_slank')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('0895-0939-5213')}\n${chalk.red('Donate')} : ${chalk.white('0888-1642-204 ( Dana )')}\n`))
}
